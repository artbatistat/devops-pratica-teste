# Importa a fun~çao de cálculo e os dados de venda do arquivo 'codigo.py'
from codigo import calcular_total_vendas , vendas_mensais

# Importar a biblioteca 'sys', que permite encerrar o programa com códigos de erro
...
# Executa a funão de teste automaticamente ao rodar este arquivo
testar_total_vendas()
